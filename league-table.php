...
try {
    ...
    $competitionDetails = $client->getAPIController()->competitionFixturesLeagueDetails(
        $format,
        $competitionId
    );
        ...
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                <a href="/soccer-v3-scores" class="d-flex align-items-center link-body-emphasis text-decoration-none">
                        <!-- <img src="../../assets/images/logo.png" width="150" height="32" class="me-2" alt=""> -->
                        <title>Soccer-v3-Scores</title>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal"><?= $competitionDetails->getName() ?></h1>
                <p class="fs-5 text-body-secondary">Current Standings</p>
            </div>
        </header>
        <main>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $data->getGoalsScored()?></td>
                            <td><?= $data->getGoalsAgainst()?></td>
                            <td><?= $data->getGoalsDifferential()?></td>
