...
/**
 * Builder for model TeamSeason
 *
 * @see TeamSeason
 */
class TeamSeasonBuilder
{
    /**
     * @var TeamSeason
     */
    ...
    private function __construct(TeamSeason $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new team season Builder object.
     */
    public static function init(): self
    {
        return new self(new TeamSeason());
    }
    ...
    /**
     * Initializes a new team season object.
     */
    public function build(): TeamSeason
    {
