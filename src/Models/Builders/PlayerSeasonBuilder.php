...
use SoccerV3ScoresLib\Models\PlayerSeason;

/**
 * Builder for model PlayerSeason
 *
 * @see PlayerSeason
 */
class PlayerSeasonBuilder
{
    ...
    private function __construct(PlayerSeason $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new player season Builder object.
     */
    public static function init(): self
    {
        return new self(new PlayerSeason());
    }
     ...
     * Sets started field.
     */
    public function started(?int $value): self
    {
        $this->instance->setStarted($value);
        return $this;
    }
    ...
    /**
     * Initializes a new player season object.
     */
    public function build(): PlayerSeason
    {
