...
class SoccerV3ScoresClientBuilder
{
    /**
     * @var array
     */
    ...
    public function ocpApimSubscriptionKey(string $ocpApimSubscriptionKey): self
    {
        $this->config['ocpApimSubscriptionKey'] = $ocpApimSubscriptionKey;
        return $this;
    }
    ...
    public function build(): SoccerV3ScoresClient
    {
        return new SoccerV3ScoresClient($this->config);
    }
}
